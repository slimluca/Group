...
export const pages: Record<string, PageContent> = {
  "south-africa": {
    ...
    description:
      "A premium Dog Haven Group gateway explaining how DogHaven South Africa fits into the global network for dog owners, travel planning, costs, and local ownership guidance.",
    ...
    sections: [
      {
        ...
        body: [
          "DogHaven South Africa serves a distinct local audience while Dog Haven Group provides the wider international framework. South African dog owners often need practical guidance that is rooted in local living conditions, local services, seasonal weather, city patterns, housing realities, and the everyday cost of responsible care. The role of this gateway is to explain that relationship clearly before sending readers to the local site.",
  ...
  "united-states": {
    ...
    description:
      "A Dog Haven Group country gateway for the United States, explaining how the US DogHaven site supports local dog owners inside the global network.",
    eyebrow: "Country gateway",
  ...
  "global-travel": {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "The route-guide model will help readers understand common movements such as South Africa to the UK, USA to Italy, Italy to Australia, and the UK to South Africa. Dog Haven Group will not create thin route pages until each guide can provide enough value, source reminders, preparation structure, and route-specific planning context.",
      ...
      {
        title: "Dog Haven Group Passport Planner concept",
        body: [
          "The future Dog Haven Group Passport Planner is a platform concept for organizing a dog's travel profile: identity details, microchip records, vaccination notes, health document windows, airline contacts, route notes, crate measurements, and official-source links. It should help owners prepare without pretending to replace government, airline, or veterinary requirements.",
          "Until that planner exists, readers can use the <a href=\"/downloads/global-dog-owner-starter-guide\">Global Dog Owner Starter Guide</a>, the <a href=\"/lab/dog-travel-checklist\">Dog Travel Checklist</a>, and the <a href=\"/global-travel/route-guides\">Route Guides</a> model to build a careful travel file."
        ]
      },
      {
        title: "Timeline, city travel, and official-source checks",
        body: [
          "International dog travel should be planned in phases: early feasibility, veterinary timeline, document windows, transport and crate decisions, accommodation, arrival transport, and first-week routine. Origin-country tasks and destination-country tasks should be separated so export steps, import steps, and transit requirements do not blur together.",
          "Dog-friendly city travel adds another layer: walking routes, heat or cold exposure, public transport norms, accommodation rules, emergency vet access, and quiet recovery time after arrival. Always check current official government, airline, transport, and veterinary sources for the exact route before booking."
        ]
      }
    ]
  },
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "The safest planning habit is to maintain a route file with dated source links, contact notes, document windows, and backup options. General DogHaven guidance can help structure the work, but current official government, airline, transport, and veterinary sources must remain the authority for the actual move."
        ],
      ...
      },
      {
        ...
        body: [
          ...
          "Before you move, download the <a href=\"/downloads/global-dog-owner-starter-guide\">Global Dog Owner Starter Guide</a>, use the <a href=\"/lab/dog-travel-checklist\">Dog Travel Checklist</a>, and watch the <a href=\"/downloads\">Download Library</a> for the future Moving Abroad With a Dog Checklist."
        ]
      }
    ]
  },
  ...
  lab: {
    ...
    description:
      "Use Dog Haven Group Lab for a dog cost calculator, breed fit quiz, puppy readiness quiz, dog travel checklist, and future planning tools.",
    ...
    sections: [
      {
        ...
        body: [
          "Dog Haven Group Lab is the interactive layer of the group site. It exists for owners who want to compare dog costs, think through breed fit, prepare for a puppy, organize travel, and eventually use playful but still polished experiences such as a dog name generator, care myth or fact quiz, guess the breed game, and daily trivia challenge.",
      ...
      {
        title: "Calculators, quizzes, games, and daily challenges",
        body: [
          "The Lab should grow into a serious platform section, not a novelty corner. Calculators can help with costs, relocation budgeting, and ownership readiness. Quizzes can frame decisions around lifestyle fit, puppy preparation, and travel complexity. Future games and daily challenges can still feel premium when they teach useful concepts instead of chasing childish styling.",
          "Planned experiences include care myth or fact, dog-friendly city challenge prompts, breed recognition games with responsible caveats, daily ownership trivia, and the future Dog Haven Group Passport Planner. Every tool should link back to long-form guidance, downloads, and country pages so interactive moments become better planning."
        ]
      },
      {
        title: "Travel planning tools and the Passport Planner",
        body: [
          "The <a href=\"/lab/dog-travel-checklist\">Dog Travel Checklist</a> is the first travel tool, but the larger direction is a Dog Haven Group Passport Planner that can organize travel profile details, document windows, route notes, source links, and arrival tasks. That future tool should remain careful: it can organize information, but it cannot replace official requirements.",
          "For now, readers should pair Lab outputs with the <a href=\"/global-travel\">Global Travel</a> hub, the <a href=\"/global-travel/moving-abroad-with-a-dog\">moving abroad guide</a>, and the <a href=\"/downloads/global-dog-owner-starter-guide\">starter guide PDF</a>."
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        body: [
          "Dog Haven Group Journal is the editorial and newsroom layer of the group site, but the website itself should not feel like a blog. The Journal can publish launch essays, methodology notes, travel planning explainers, safety updates, ownership trend analysis, country spotlights, and DogHaven network updates when there is something useful to say.",
      ...
      {
        title: "What the Journal will publish",
        body: [
          "The Journal should become the place for useful global dog ownership updates, travel and moving-abroad planning explainers, safety and seasonal guidance, DogHaven network updates, country spotlights, and methodology notes. It should not publish fake dates, invented news, or generic filler just to look active.",
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Every downloadable resource should use the Dog Haven Group logo, black, gold, and ivory premium identity, a professional cover page, footer links, and clear links back to DogHavenGroup.com. The first live resource is the <a href=\"/downloads/global-dog-owner-starter-guide\">Global Dog Owner Starter Guide</a>, which connects first-time planning with the <a href=\"/world-atlas\">World Atlas</a>, <a href=\"/global-travel\">Global Travel</a>, <a href=\"/lab\">Lab</a>, <a href=\"/academy\">Academy</a>, and <a href=\"/countries\">Country Network</a>."
        ],
      ...
      },
      {
        ...
        body: [
          "The Download Library should feel curated. A resource earns its place when it gives the reader a practical planning object: a checklist, worksheet, budget file, timeline, emergency sheet, or decision framework that is easier to use than a long article alone.",
          "The next resources should support moving abroad with a dog, international travel planning, cost planning, puppy first-month routines, emergency preparedness, and breed-fit decisions. Each download should have a related live page so readers can move between printable planning and updated website guidance."
        ]
      }
    ]
  },
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Future country entries are shown as planned markets only. Dog Haven Group should not create thin future country pages until there is enough useful content, local context, and editorial purpose to justify them."
        ],
  ...
  about: {
    ...
    description:
      "Learn about Dog Haven Group, the premium global parent platform for the DogHaven country network, ownership intelligence, travel planning, tools, Academy, Journal, and downloads.",
    eyebrow: "About",
    ...
    sections: [
      {
        ...
        body: [
          "Dog Haven Group is the global home of the DogHaven network. It connects local country sites with broader planning resources for dog ownership, international travel, learning, cost awareness, tools, and responsible editorial guidance.",
...
export const journalArticles = [
  {
    ...
    description: "Why Dog Haven Group exists as the global home of the DogHaven network and what Phase 1 of the platform is built to do.",
