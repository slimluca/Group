...
export default function Page() {
  return (
    <>
      ...
      <section className="section"><div className="shell split"><div><p className="eyebrow">DogHaven Journal</p><h1>{article.title}</h1><p className="lead">{article.description}</p></div><MediaFrame image={{ src: article.image, alt: "DogHaven global dog travel planning article visual with routes and documents." }} /></div></section>
